        ...
        <div className="mx-auto max-w-2xl">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-zinc-400">{targetProfile.email}</p>
            </div>
            <Link href="/manager/users" className="text-sm font-medium text-blue-600 dark:text-blue-400 hover:underline">
              Back
            </Link>
          </div>

          <div className="mb-4 rounded-xl bg-white p-4 shadow-sm border border-gray-100 dark:bg-zinc-900 dark:border-zinc-900">
            <p className="mb-3 text-sm font-semibold text-gray-900 dark:text-zinc-50">Role</p>
            <RoleToggle
          ...
          <div className="mb-4 rounded-xl bg-white p-4 shadow-sm border border-gray-100 dark:bg-zinc-900 dark:border-zinc-900">
            <p className="mb-3 text-sm font-semibold text-gray-900 dark:text-zinc-50">Jar assignment</p>
            <UserJarAssignment
          ...
          <div className="rounded-xl bg-white p-4 shadow-sm border border-gray-100 dark:bg-zinc-900 dark:border-zinc-900">
            <p className="mb-3 text-sm font-semibold text-gray-900 dark:text-zinc-50">Expenses</p>
            ...
            {expenses && expenses.length > 0 ? (
              <div className="space-y-2">
                {expenses.map((e) => (
                  <div key={e.id} className="flex items-center justify-between text-sm">
                    <div>
                      <p className="text-gray-900 dark:text-zinc-100">{e.category_name}</p>
              ...
              <p className="text-sm text-gray-500 dark:text-zinc-400">No expenses logged yet.</p>
            )}
              ...
              <div className="mt-4 flex items-center justify-between border-t border-gray-100 pt-3 dark:border-zinc-800">
                <NavLinkButton
                  ...
                  className={`text-sm font-medium ${
                    page <= 1 ? 'pointer-events-none text-gray-300 dark:text-zinc-700' : 'text-blue-600 dark:text-blue-400 hover:underline'
                  }`}
                >
                  Previous
                </NavLinkButton>
                ...
                <NavLinkButton
                  href={`?page=${page + 1}`}
                  className={`text-sm font-medium ${
                    page >= totalPages ? 'pointer-events-none text-gray-300 dark:text-zinc-700' : 'text-blue-600 dark:text-blue-400 hover:underline'
                  }`}
                >
                  Next
                </NavLinkButton>
