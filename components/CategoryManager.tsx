    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-xl bg-white p-4 shadow-sm">
                ...
                >
                    <p className="text-sm font-semibold text-gray-900">Add a category</p>
                    <svg
                ...
                {showAddForm && (
                    <div className="mt-3">
                        {jars.length === 0 ? (
                            ...
                            <>
                                <label className="mb-1 block text-xs font-medium text-gray-500">Jar</label>
                                <select
                                    value={newJarId}
                                        ...
                                        {editingId === category.id ? (
                                            <div className="rounded-lg bg-gray-50 p-3">
                                                <input
                                                    ...
                                                    className="mb-2 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none"
                                                />
                                                {editError && (
                                                    <p className="mb-2 text-sm text-red-600">{editError}</p>
                                                )}
                                                <div className="flex gap-2">
                                                    <button
                                                        onClick={cancelEdit}
                                                        disabled={saving}
                                                        className="flex-1 rounded-lg bg-gray-100 py-1.5 text-sm font-medium text-gray-700 disabled:opacity-50"
                                                    >
                                                        Cancel
                                                    </button>
                                                    <button
                                                        ...
                                                        disabled={saving}
                                                        className="flex-1 rounded-lg bg-gray-900 py-1.5 text-sm font-medium text-white disabled:opacity-50"
                                                    >
                                                        {saving ? 'Saving...' : 'Save'}
                                                    </button>
                                                </div>
                                            ...
                                            <div className="rounded-lg bg-red-50 p-3">
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        disabled={deleting}
                                                        className="flex-1 rounded-lg bg-white py-1.5 text-sm font-medium text-gray-700 shadow-sm disabled:opacity-50"
                                                    >
                                                        Cancel
                                                    </button>
                                                    <button
                                                        ...
                                                        disabled={deleting}
                                                        className="flex-1 rounded-lg bg-red-600 py-1.5 text-sm font-medium text-white disabled:opacity-50"
                                                    >
